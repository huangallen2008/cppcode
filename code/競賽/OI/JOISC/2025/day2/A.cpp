...
signed main() {
    ...
    for(auto ms:vsum) {
        for(auto md:vdif) {
            ...
            REP(k,SZ(v[0][0])) pv[0][0][1][k+1]=v[0][0][k].f-1+l-v[0][0][k].s;
            REP(k,SZ(v[1][0])) pv[1][0][0][k+1]=v[1][0][k].f-1+l-v[1][0][k].s;
            REP(k,SZ(v[1][0])) pv[1][0][1][k+1]=l-v[1][0][k].f+l-v[1][0][k].s;
            REP(k,SZ(v[1][1])) pv[1][1][0][k+1]=l-v[1][1][k].f+l-v[1][1][k].s;
            REP(k,SZ(v[1][1])) pv[1][1][1][k+1]=l-v[1][1][k].f+v[1][1][k].s-1;
            REP(k,SZ(v[0][1])) pv[0][1][0][k+1]=l-v[0][1][k].f+v[0][1][k].s-1;
            REP(k,SZ(v[0][1])) pv[0][1][1][k+1]=v[0][1][k].f-1+v[0][1][k].s-1;
